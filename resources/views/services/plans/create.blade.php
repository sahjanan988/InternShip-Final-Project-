                ...
                <div class="col mg-t-10">
                    <div class="card ht-lg-100p">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h6 class=" h4 mg-b-0">Add New Plan</h6>
                        </div><!-- card-header -->
                        <div class="card-body pd-b-0">
                            ...
                            @endif
                                ...
                                @endif
                            <form id="create-plan" action="{{route('plans.create')}}" method="post" data-parsley-validate>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" placeholder="Enter plan name" value="{{old('name')}}" required>
                                                </div>
                                            </div><!-- form-group -->
                                        </div>
                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="inputUpload" type="text" name="upload" class="form-control" placeholder="Enter upload rate"  value="{{old('upload')}}" required>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="inputDownload" type="text" name="download" class="form-control" placeholder="Enter download rate"  value="{{old('download')}}" required>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><strong>MB</strong></span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="inputCost" type="number" name="cost" class="form-control" placeholder="Enter plan cost" value="{{old('cost')}}" required>
                                                    <div class="input-group-append">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="inputPrice" type="number" name="price" class="form-control" placeholder="Enter retail price" value="{{old('price')}}" required>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><strong>LBP</strong></span>
                                                    </div>
                                                </div>
