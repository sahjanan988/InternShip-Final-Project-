                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit iPTV Plan</li>
                        </ol>
                    </nav>
                ...
                <div class="col mg-t-10">
                    <div class="card ht-lg-100p">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h6 class=" h4 mg-b-0">Edit iPTV Plan</h6>
                        </div><!-- card-header -->
                        <div class="card-body pd-b-0">
                            ...
                            @endif
                                ...
                                @endif
                            <form id="edit-plan" action="{{route('iptv.edit',$plan->id)}}" method="post" data-parsley-validate>
