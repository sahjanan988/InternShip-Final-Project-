                ...
                <div class="col mg-t-10">
                    <div class="card ht-lg-100p">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h6 class=" h4 mg-b-0">Edit Employee</h6>
                        </div><!-- card-header -->
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" placeholder="Enter Name" autocomplete="name" value="{{(old('name') == '') ? $employee->name : old('name') }}" required>
                                                </div>
                                            </div><!-- form-group -->
                                        </div>
                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="inputPhoneNumber" type="text" name="phone" class="form-control" placeholder="Enter Phone Number" autocomplete="tel-national" value="{{(old('phone') == '') ? $employee->phone : old('phone') }}" required>
                                                </div>
                                            </div><!-- form-group -->
                                        </div>
                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="inputSalary" type="number" name="salary" class="form-control" placeholder="Enter Salary" value="{{(old('salary') == '') ? $employee->salary : old('salary') }}" required>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="inputEnroll" type="text" name="enrolled_at" class="form-control" placeholder="Enter Date of Enrollment" value="{{(old('enrolled_at') == '') ? date("Y-m-d",strtotime($employee -> enrolled_at)) : old('enrolled_at') }}" required>
